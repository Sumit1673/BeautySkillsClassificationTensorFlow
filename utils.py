...
def change_file_name(src_folder:str, dest_path=None,prefix=None, t='beauty', ext='.jpg') -> None:
    ...
    try:
        ...
        for id, i_file in enumerate(pbar):
            file_name = t + '_'+prefix + '_'+str(id) + ext
...
def dataset_creation(dataset_path, multi_label=False, src_folder='../Dataset/'):
...
def create_labels(dataset_path='beauty_dataset2.csv'):
    multi_label = False
    if not os.path.exists(dataset_path):
        with open(dataset_path, 'a') as csv_file:
            writer = csv.writer(csv_file, delimiter=',', quotechar='|', quoting=csv.QUOTE_MINIMAL)
    ...
    dataset_creation(dataset_path, multi_label=multi_label, src_folder='/home/sumit/Documents/SEW/Dataset')

if __name__ =="__main__":
    # create_labels()
    src = "../Dataset3/2021-03-05"
    ...
    # print(folders)
    # folders.remove('../Dataset/non_beauty')
    # print(folders)
    # print(folders)
    list(filter(change_file_name, src))
    # # change_file_name(
